...
const LoginForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Điều hướng người dùng đến trang chủ hoặc trang phù hợp
            navigate('/');
            ...
            <div className="card border-light-subtle shadow-sm">
                <div className="row g-0">
                    <div className="col-12 col-md-6 text-bg-primary">
                        <div className="d-flex align-items-center justify-content-center h-100" style={{ 'background-color': '#29ca8e' }}>
                                    ...
                                    <div className="d-flex gap-3 flex-column flex-xl-row">
                                        ...
                                        <a href="#!" className="btn bsb-btn-xl btn-outline-primary">
                                            <svg
                                                ...
                                                viewBox="0 0 16 16"
                                            >
                                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.305.618-1.305 1.251v1.45h2.121l-.34 2.64h-1.781v5.625C13.074 15.396 16 12.066 16 8.05z" />
                                            </svg>
