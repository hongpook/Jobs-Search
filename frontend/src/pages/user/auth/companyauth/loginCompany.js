...
import imgLogin from '../../../../assets/images/imgLoginC.png';
import "../login.css";
            ...
            <div className="card-body p-3 p-md-4 p-xl-5">
              <div className="row">
                <div className="col-12">
                  <div className="mb-5">
                    <h3>{t('loginCompany.login_title')}</h3>
                  </div>
                </div>
              </div>
                ...
                <div className="row gy-3 gy-md-4 overflow-hidden">
                  <div className="col-12">
                    <label htmlFor="email" className="form-label">
                      {t('loginCompany.email_label')} <span className="text-danger">*</span>
                    </label>
                    <input
                      className="form-control"
                      type="email"
                      name="email"
                      placeholder={t('loginCompany.email_placeholder')}
                  ...
                  <div className="col-12">
                    <label htmlFor="password" className="form-label">
                      {t('loginCompany.password_label')} <span className="text-danger">*</span>
                    </label>
                    <input
                      type="password"
                      className="form-control"
                      name="password"
                      placeholder={t('loginCompany.password_placeholder')}
                ...
                <div className="col-12">
                  ...
                  <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                    ...
                    <a href="#!" className="link-secondary text-decoration-none">
                      {t('loginCompany.forgot_password')}
                    </a>
                  </div>
                </div>
              </div>
